...
const NavBar = () => {
  ...
  return (
    <nav className="w-11/12 mx-auto absolute top-5 flex flex-col md:flex-row gap-4 justify-between items-center py-6 bg-transparent z-10 rounded-lg shadow-lg">
